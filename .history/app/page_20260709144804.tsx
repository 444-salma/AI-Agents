      ...
      <div className="max-w-4xl mx-auto px-6 pb-12 space-y-10 -mt-2">
          ...
          <div className="glass-card rounded-3xl p-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                ...
                {
                  l: t.clientSince,
                  v: new Date(company.relationship_since)
                    .getFullYear()
                    .toString(),
                },
        ...
        <section>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {statusCards.map(
              (
                { icon: Icon, label, value, sub, gradient, bg, border, text },
                i,
              ) => (
                <div
                  key={label}
                ...
                >
                  ...
                  <div>
                    <p className={`text-base font-extrabold ${text}`}>
                      {value}
                    </p>
        ...
        <section>
          ...
          <div className="glass-card-blue rounded-3xl p-6 border relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div
                className={`transition-all duration-700 ${typingDone ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`}
              >
