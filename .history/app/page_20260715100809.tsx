...
export default function Dashboard() {
  ...
  const aiFindings = [
    {
      num: "01",
      title: "Company",
      insight: "11-year banking relationship.",
    ...
    },
    {
      num: "03",
      title: "Documents",
      insight: `${missing + needsUpdate} documents need renewal.`,
    ...
    },
    {
      num: "04",
      title: "Compliance",
      insight: "Renewal required before credit processing.",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-6 -mt-2 mb-6 relative z-10">
        <div className="rounded-2xl border border-blue-200/70 dark:border-blue-900/40 bg-white dark:bg-slate-900 shadow-sm px-5 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-center gap-3 sm:gap-5 text-sm font-semibold text-slate-700 dark:text-slate-200">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-12 space-y-10 -mt-2">
        ...
        <section>
          ...
          <div className="glass-card-blue rounded-3xl px-5 py-4 border">
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-slate-700 dark:text-slate-300">
                  Strong financial health and low customer risk.
                </p>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm font-semibold text-slate-800 dark:text-slate-200">
                  Renew the Commercial Registration before credit processing
                  continues.
                </p>
              </div>
            </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {aiFindings.map(({ num, title, insight, color, dotColor }, i) => (
              <div
                key={num}
                className="card-lift glass-card rounded-2xl px-5 py-4 animate-slide-up"
        ...
        {/* ================================================================
            ...
            ================================================================ */}
        <section>
          <SectionLabel>AI Decision & Next Action</SectionLabel>
          <div className="glass-card rounded-3xl overflow-hidden">
            ...
            <div className="px-6 pt-6 pb-5 space-y-5">
              ...
              <div className="space-y-0 divide-y divide-slate-100/80 dark:divide-white/[0.06]">
                <InfoRow
                  label="Reason"
                  value="Commercial Registration expires within 30 days."
                />

                <InfoRow label="Impact" value="Credit processing may stop." />
              </div>
