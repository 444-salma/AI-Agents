...
export default function AICopilotPage() {
  ...
  useEffect(() => {
    ...
    const st = mockFinancialStatements;
    const prods = mockBankingProducts;
    const tl = mockTimelineEvents;
        ...
        {!hasMessages ? (
          <div className="flex flex-col items-center justify-center h-full max-w-2xl mx-auto text-center">
            ...
            <p className="text-sm text-muted-foreground mb-8 max-w-md leading-relaxed">
              Four AI agents have analyzed this customer&apos;s profile,
              financials, documents, and compliance. Ask a question or pick a
              prompt below.
            </p>
